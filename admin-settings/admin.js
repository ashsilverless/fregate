...
mapInsert.innerHTML = '<img src="http://' + window.location.hostname + '/wp-content/themes/fregate/inc/img/island-flatv1.png" style="width:100%; height:auto"/>';
...
var positionVert = document.getElementById("map-vert").getElementsByClassName('acf-is-appended')[0];
var positionHoriz = document.getElementById("map-horiz").getElementsByClassName('acf-is-appended')[0];
